<section class="overview">
	...
	<p>Basic concepts, coding standards, accessibility guidelines, and technologies of client-side Web page design. Hypertext Markup Language (HTML), Cascading Style Sheets (CSS), and techniques for controlling page layout, animations, and user interactions.</p>
</section>
<section>
	<header>
		<h2 id="client">Client Project</h2>
		<hr>
	</header>
	<h3>The Client</h3>
...
<section>
	<header>
		<h2 id="portfolio">Portfolio Design</h2>
		<hr>
	</header>
	<p>Portfolio lab is about you! You are designing to showcase you and your talents.</p>
	<h3>Requirements</h3>
	<ul>
...
<section class="labs">
	...
	<a href="labs/lab-0.html"><h3>Lab 0</h3></a>
	<a href="labs/lab-1.html"><h3>Lab 1</h3></a>
	<a href="#"><h3>Lab 2</h3></a>
	<a href="#"><h3>Lab 3</h3></a>
	<a href="#"><h3>Lab 4</h3></a>
	<a href="#"><h3>Lab 5</h3></a>
	<a href="#"><h3>Lab 6</h3></a>
	<a href="#"><h3>Lab 7</h3></a>
	<a href="#"><h3>Lab 8</h3></a>
	<a href="#"><h3>Lab 9</h3></a>
	<a href="#"><h3>Lab 10</h3></a>
	<a href="#"><h3>Lab 11</h3></a>
	<a href="#"><h3>Lab 12</h3></a>
	<a href="#"><h3>Lab 13</h3></a>
	<a href="#"><h3>Lab 14</h3></a>
	<a href="#"><h3>Lab 15</h3></a>
	<a href="#"><h3>Lab 16</h3></a>
	<a href="#"><h3>Lab 17</h3></a>
</section>